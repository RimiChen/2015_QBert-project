...
QBert_Cube_Item::QBert_Cube_Item(){
...
void QBert_Cube_Item::setColor_Back(vec3 newColor){
	colorBack = newColor;
	//updateColor();
	int shift = 6;
...
void QBert_Cube_Item::setColor_Front(vec3 newColor){
	colorFront = newColor;
	//updateColor();
	int shift = 4;
...
void QBert_Cube_Item::setColor_Top(vec3 newColor){
	colorTop = newColor;
	//updateColor();
	int shift = 2;
...
void QBert_Cube_Item::setColor_Bottom(vec3 newColor){
...
void QBert_Cube_Item::setColor_Left(vec3 newColor){
	colorLeft = newColor;
	//updateColor();
	int shift = 8;
...
void QBert_Cube_Item::setColor_Right(vec3 newColor){
	colorRight = newColor;
	//updateColor();
	int shift = 10;
...
void QBert_Cube_Item::setTranlation(float x_shift, float y_shift, float z_shift){
	translation = glm::translate ( mat4(), vec3 (x_shift, y_shift, z_shift));
	currentPosition = vec3 (x_shift, y_shift, z_shift);
}
void QBert_Cube_Item::setScale(float x_scale, float y_scale, float z_scale){
	scaleMatrix = glm::scale( mat4(), vec3 (x_scale, y_scale, z_scale));
}
	// only y rotate
void QBert_Cube_Item::setRotate(float radius){
	rotateMatrix = glm::rotate(glm::mat4(), glm::radians(radius), glm::vec3(0,1,0));
}
void QBert_Cube_Item::setAllColor(vec3 newColor){
...
void QBert_Cube_Item::updateColor(){
	GLfloat tempColorArray[] = 
	{ 
    //  R     G     B 
    // bottom
